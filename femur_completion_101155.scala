...
object femur_completion_101155 {
  ...
  def main(args: Array[String]) {
    ...
    val femur_partial = MeshIO.readMesh(new java.io.File("data/partials/101155/101155.stl")).get

    val targetGroup = ui.createGroup("target")
    ui.show(targetGroup, femur_partial, "femur_broken")

    val smallModel = StatisticalModelIO.readStatisticalMeshModel(new java.io.File("data/results/22_aligned.h5")).get
    ...
    val referenceLandmarks = LandmarkIO.readLandmarksJson[_3D](new java.io.File("data/ref_22_aligned.json")).get
    ...
    val femur_partialLandmarks = LandmarkIO.readLandmarksJson[_3D](new java.io.File("data/partials/101155/101155.json")).get
    ...
    val femur_partialPtIDs = model.referenceMesh.pointSet.pointIds.filter { id =>
      (model.referenceMesh.pointSet.point(id) - model.referenceMesh.pointSet.point(PointId(100))).norm <= 50
    }
    ...
    val filename=new File("Data/results/101155_aligned.stl")
