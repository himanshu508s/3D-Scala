...
object femur_example_middle {
  def main(args: Array[String]): Unit = {
    ...
    for(i <- 0 to 49) {
      ...
      val topFemur = referencePointSet.point(PointId(8550))
      ...
      StatisticalModelIO.writeStatisticalMeshModel(femurModel, new java.io.File("data/femur_middle/femur_middle_" + i + ".h5"))
