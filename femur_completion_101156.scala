...
object femur_completion_101156 {
  ...
  def main(args: Array[String]) {
    ...
    val smallModel = StatisticalModelIO.readStatisticalMeshModel(new java.io.File("data/results/2_aligned.h5")).get
    ...
    val referenceLandmarks = LandmarkIO.readLandmarksJson[_3D](new java.io.File("data/ref_2_aligned.json")).get
    ...
    val femur_partialLandmarks = LandmarkIO.readLandmarksJson[_3D](new java.io.File("data/partials/101156/101156.json")).get
    ...
    val femur_partialPtIDs = model.referenceMesh.pointSet.pointIds.filter { id =>
      (model.referenceMesh.pointSet.point(id) - model.referenceMesh.pointSet.point(PointId(16200))).norm <= 85
    }
//val x=model.referenceMesh.pointSet.findClosestPoint(<give_coordinates>).id
    ...
    val filename=new File("Data/results/101156_aligned.stl")
