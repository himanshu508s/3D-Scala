...
object femur_completion_101154 {
  ...
  def main(args: Array[String]) {
    ...
    val femur_partial = MeshIO.readMesh(new java.io.File("data/partials/101154/101154.stl")).get
    ...
    val referenceLandmarks = LandmarkIO.readLandmarksJson[_3D](new java.io.File("data/ref_6_aligned1.json")).get
    ...
    val femur_partialLandmarks = LandmarkIO.readLandmarksJson[_3D](new java.io.File("data/partials/101154/101154.json")).get
    ...
    val femur_partialPtIDs = model.referenceMesh.pointSet.pointIds.filter { id =>
      (model.referenceMesh.pointSet.point(id) - model.referenceMesh.pointSet.point(PointId(200))).norm <= 90
    }
    ...
    StatisticalModelIO.writeStatisticalMeshModel(posterior_femur_partialModel, new java.io.File("data/101154_aligned_final.h5"))

    val meanFemur : TriangleMesh[_3D] = posterior_femur_partialModel.mean
    ui.show(posterior_femur_partialGroup, meanFemur, "meanFemur")
    val filename=new File("Data/results/101154_aligned.stl")
